 ...
 * @version     CVS: $Id: Validator_MobileBlock.class.php,v 1.1 2008/06/05 01:22:16 snakajima Exp $
 */
 ...
 * @since       3.0.0
 */
class Calendar_Validator_MobileBlock extends Validator
{
    /**
     * ブロックに配置しているかどうかをチェック
     *
    ...
    function validate($attributes, $errStr, $params)
    {
		...
		$module_name = $modulesView->loadModuleName("calendar");
