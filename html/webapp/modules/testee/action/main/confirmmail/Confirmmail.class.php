 ...
 * @access      public
 */
class Testee_Action_Main_Confirmmail extends Action
{
    // リクエストパラメータを受け取るため
 	var $room_id = null;
 	var $block_id = null;
    ...
    function execute()
    {
		$content_id = $this->session->getParameter("testee_confirm_mail_content_id");
		...
		$mail = $this->mdbView->getTestee($testee_id);
		...
		$this->mailMain->send();
		$this->session->removeParameter("testee_confirm_mail_content_id");
