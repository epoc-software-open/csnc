 ...
 * @access      public
 */
class Testee_Action_Main_Delcontent extends Action
{
	// リクエストパラメータを受け取るため
	var $content_id = null;
	var $block_id = null;
	...
	function execute()
	{
	    ...
	    $this->request->setParameter('_redirect_url', BASE_URL.INDEX_FILE_NAME."?active_action=testee_view_main_init&block_id=$this->block_id&content_id=$this->content_id#$topid");
