 ...
 * @access      public
 */
class Testee_Validator_Chgseq extends Validator
{
    /**
     * validate実行
     *
    ...
    function validate($attributes, $errStr, $params)
    {
		...
		$contents = $db->selectExecute("testee_content",$params, null, null, null, array($this, "_getContentFetchcallback") , $content_id_arr);
        if ($contents === false) {
        	return $errStr;
        }
